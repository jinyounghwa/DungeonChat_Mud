...
### v1.3.0 (2025-12-17) 🚀 Latest
- ✅ **동적 선택지 시스템**: AI가 상황에 맞는 2가지 선택지 자동 생성
- ✅ **체력 즉시 반영**: 모든 요청에서 매번 체력 변화 적용 (첫 요청부터!)
- ✅ **체력 감지 로직 대폭 강화**:
  - "체력이 변하지 않는다" 표현 감지
  - "-" 기호 패턴 추가
  - "체력: 85/100" 표기 형식 감지
- ✅ **프론트엔드 게임 상태 초기화**: ChatScreen에서 게임 시작 시 자동으로 상태 로드
- ✅ **AI 프롬프트 강화**: 매 응답에 체력 변화를 필수로 포함하도록 명시
...
**Last Updated**: 2025-12-17 | **Version**: v1.3.0 | **Status**: ✅ Production Ready
